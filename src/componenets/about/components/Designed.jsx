  ...
  return (
    <section className=" flex flex-col md:flex-row">
      <div className="bg-black text-white flex flex-col justify-center w-full md:w-1/2">
        <div className="px-8 sm:px-10 md:px-12 lg:px-16 xl:px-24 py-16 md:py-12 lg:py-0">
          <h1 className="Mycontainer text-4xl sm:text-5xl lg:text-4xl xl:text-5xl font-extrabold leading-tight mb-6">
            Thoughtfully Designed for All
          </h1>

          <p className="Mycontainer not-odd:text-gray-300 text-base sm:text-lg lg:text-base xl:text-lg leading-relaxed">
            ...
            at Velora is designed with real life in mind — easy to wear, easy to
            love.
            <br />
            <br />
